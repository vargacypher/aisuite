"""The interface to Google's Generative AI."""
...
class GoogleProvider(ProviderInterface):
    ...
    def __init__(self, **config):
        ...
        self.client_configs = config.get("client_configs", None)
    ...
    def chat_completions_create(self, model, messages, **kwargs):
        ...
        if tools:
            ...
            # TODO add tool_config to support mode and allowed_function_names
        ...
        for message in messages:
            ...
            if tool_calls:
                for tool_call in tool_calls:
                    ...
                    function_calls[function_name] = Part(
                        {
    ...
    def normalize_response(self, response: GenerateContentResponse):
    ...
    def _extract_tool_calls(self, response: GenerateContentResponse) -> list[dict]:
        """
